                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            child:
                                Text(TempData.editEvetAddress, style: paragraphStyle))
                      ],
                    ),
                    SizedBox(height: 16),
                    Row(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 5),
                    SizedBox(height: 20,child: ListView.separated(separatorBuilder: (context, index) => Text(", ",style: paragraphStyle,),scrollDirection: Axis.horizontal,shrinkWrap: true,itemCount: TempData.editEventTags.length,itemBuilder: (context, index) => Text("#${TempData.editEventTags[index]}",style: paragraphStyle))),
                  ],
                ),
              ),
              SizedBox(height: 16),
                      ...
                      CreateEventService()
                          .editEventServices(
                            context,
                              ...
                              draft: false,
                              thumbnailImg:globalController.eventThumbnailImgPath.value==''?widget.eventData.thumbnail:globalController.eventThumbnailImgPath.value,
                              images: tempImgs,
