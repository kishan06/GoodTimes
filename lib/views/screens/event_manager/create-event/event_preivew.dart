              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                              child:
                                  Text(TempData.evetAddress, style: paragraphStyle))
                        ],
                      ),
                      SizedBox(height: 16),
                      Row(
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('About this event', style: labelStyle.copyWith(fontWeight: FontWeight.w500)),
                      SizedBox(height: 5),
                      Text(TempData.evetDescription, style: paragraphStyle),
                      SizedBox(height: 15),
                      Text('Key Guest',style: labelStyle.copyWith(fontWeight: FontWeight.w500)),
                      SizedBox(height: 5),
                      Text(TempData.eventKeyGuest, style: paragraphStyle),
                      SizedBox(height: 15),
                      Text('Coupon Code',style: labelStyle.copyWith(fontWeight: FontWeight.w500)),
                      SizedBox(height: 5),
                      Text(TempData.couponCode, style: paragraphStyle),
                      SizedBox(height: 15),
                       Text('Coupon Code Descriptions',style: labelStyle.copyWith(fontWeight: FontWeight.w500)),
                      SizedBox(height: 5),
                      Text(TempData.couponCodeDescription, style: paragraphStyle),
                      SizedBox(height: 15),
                      Text('Tags', style: labelStyle.copyWith(fontWeight: FontWeight.w500)),
                      SizedBox(height: 5),
                      SizedBox(height: 20,child: ListView.separated(separatorBuilder: (context, index) => Text(", ",style: paragraphStyle,),scrollDirection: Axis.horizontal,shrinkWrap: true,itemCount: TempData.eventTags.length,itemBuilder: (context, index) => Text("#${TempData.eventTags[index]}",style: paragraphStyle))),
                    ],
                  ),
                ),
                SizedBox(height: 16),
                      ...
                      onPressed: () {
                        ...
                        CreateEventService()
                            .createEventServices(context,
                                ...
                                couponDescriptionController: TempData.couponCodeDescription,
                                  draft: false,
                                thumbnailImg:
