...
class _VerifyOTPState extends State<VerifyOTP> {
  ...
  void dispose() {
   ...
   // textEditingControllerOtp.dispose();
            ...
            children: [
              ...
              MyElevatedButton(
                ...
                onPressed: () {
                   ...
                   verifyAndContinue(context,email:email,otp:textEditingControllerOtp.text);
          ...
          waiting = true;
            ...
            RegistrationProccess()
                .preVerifyOTP(context,
                    otp: textEditingControllerOtp.text, email: email)
                .then(
              (value) {
                if (value.responseStatus == ResponseStatus.success) {
                  setState(() {
                  ...
                  Navigator.pushReplacementNamed(context,CreatePassword.routeName,arguments: [email,'resetPassword']);
                } else {
                  setState(() {
                    waiting = false;
                  });
